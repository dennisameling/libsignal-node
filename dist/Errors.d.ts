...
export declare type VerificationFailedError = SignalClientErrorCommon & {
    code: ErrorCode.VerificationFailed;
};
export declare type SignalClientError = GenericError | DuplicatedMessageError | SealedSenderSelfSendError | UntrustedIdentityError | InvalidRegistrationIdError | VerificationFailedError;
